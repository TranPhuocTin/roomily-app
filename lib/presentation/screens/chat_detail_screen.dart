...
//         // Check if this is a system message and handle status updates
...
//   // Optimize _handleSystemMessage to prevent unnecessary refresh calls
//   void _handleSystemMessage(ChatMessage message) {
//     final String messageContent = message.content ?? '';

//     if (kDebugMode) {
//       print('📱 ChatDetailScreen: Processing system message: ${message.displayMessage}');
//     }

//     // Check if it's a rental request related message and if we need to refresh
//     bool isNewRentalRequestMessage =
//         messageContent.contains('yêu cầu thuê phòng') && _chatRoomInfo.rentalRequest == null;

//     bool isStatusChangeMessage =
//         (messageContent.contains('đã chấp nhận') && _requestStatus != RentalRequestStatus.APPROVED) ||
//         (messageContent.contains('đã từ chối') && _requestStatus != RentalRequestStatus.REJECTED) ||
//         (messageContent.contains('bị hủy') && !_isChatRoomCanceled);

//     // Only refresh room info card if there's an actual status change needed
//     if (isNewRentalRequestMessage || isStatusChangeMessage) {
//       if (kDebugMode) {
//         print('📱 ChatDetailScreen: Detected status change in message, refreshing room info only');
//       }

//       // Only refresh the chat room info (not the message list)
//       _refreshChatRoomInfo();
//     } else {
//       if (kDebugMode) {
//         print('📱 ChatDetailScreen: No relevant status change in message, skipping refresh');
//       }
//     }
//   }
// }
...
//       if(kDebugMode){
//         print('🎯 ChatDetailScreen: Building rent request button');
//         print('🎯 ChatDetailScreen: isRoomRented: $isRoomRented');
//         print('🎯 ChatDetailScreen: requestStatus: $requestStatus');
//         print('🎯 ChatDetailScreen: widget.isLandlord: ${widget.isLandlord}');
//         print('🎯 ChatDetailScreen: widget.chatRoomInfo.chatRoomStatus: ${widget.chatRoomInfo.chatRoomStatus}');
//       }
...
//                     context.findAncestorWidgetOfExactType<ChatDetailScreen>()!.chatRoomInfo.chatRoomId,
//                   ),
